    ...
    public partial class Form1 : Form
    {
        ...
        private void CPUmove(object sender, EventArgs e)
        {
            if (buttons.Count > 0)
            {
                ...
                Button chosenButton = buttons[index];

                currentPlayer = Player.O;
                chosenButton.Text = currentPlayer.ToString();
                chosenButton.Enabled = false;
                chosenButton.BackColor = Color.DarkSalmon;
        ...
        private void CheckGame()
        {
            ...
            {
                CPUTimer.Stop();
                MessageBox.Show("CPU Wins", "Congratulations");
                CPUWinCount++;
